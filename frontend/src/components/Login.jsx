...
const Login = () => {
  ...
  const handleAnimationEnd = async (e) => {
    // Срабатываем только на основную анимацию контейнера
    if (e.animationName !== 'LoginContainer') return
      ...
      <div className="login-page">
        <div className="login-panel">
          <div className="login-brand">
            <img src="/img/coffee-svgrepo-com.svg" alt="Coffee" className="login-brand-icon" />
            <span className="login-brand-strong">coffee</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <div className="login-row">
              ...
              <button 
                type="submit" 
                className="login-fingerprint-btn" 
                disabled={loading || animating}
                ref={buttonRef}
                onAnimationEnd={handleAnimationEnd}
              >
                <span className="login-btn-text">{loading ? 'Вход...' : 'Войти'}</span>
